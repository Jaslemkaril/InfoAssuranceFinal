...
<head>
  ...
  <title>Hello - Secure Login</title>
  <style>
    ...
    * {
    ...
    .field input:invalid:not(:placeholder-shown) ~ .field-hint {
      display: block;
    }
    ...
    .notice--error { display: flex; align-items: flex-start; gap: 0.5rem; }
    .notice--success { display: flex; align-items: flex-start; gap: 0.5rem; }
...
<body>
  <div class="shell">
    <section class="art">
      ...
      <div>
        <p>Log your Account to get full User Experience</p>
      </div>
    </section>
